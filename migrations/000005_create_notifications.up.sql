CREATE TABLE notifications (
    ...
    type VARCHAR(40) NOT NULL CHECK (type IN (
        ...
        'CONTRIBUTION_APPROVED','CONTRIBUTION_REJECTED','SUPPORT_REQUEST',
        'SUPPORT_REQUEST_RECEIVED','CONTRIBUTION_REVIEW_REMINDER'
    )),
    channel VARCHAR(20) NOT NULL CHECK (channel IN ('EMAIL','IN_APP')), recipient VARCHAR(320) NOT NULL,
    ...
    sent_at TIMESTAMPTZ, read_at TIMESTAMPTZ, attachment_key TEXT, proof_url TEXT, approve_url TEXT, reject_url TEXT,
